...
!(function (n, r) {
  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
        ? define ('underscore', r)
        : ((n = 'undefined' != typeof globalThis ? globalThis : n || self), (t =
            n._), ((e = n._ = r ()).noConflict = function () {
            return (n._ = t), e;
          }));
}) (this, function () {
  var n = '1.13.6',
  ...
  function j (n) {
    for (
      var r = b (n), t = r.length, e = Array (t), u = 0;
      u < t;
      u++
    ) e[u] = n[r[u]];
    return e;
  ...
  function Vn (n, r) {
    return null == r &&
      ((r = n), (n = 0)), n + Math.floor (Math.random () * (r - n + 1));
  }
  ...
  function Zn (n, r) {
    ...
    return function () {
      return 0 < --n &&
        (t = r.apply (this, arguments)), n <= 1 && (r = null), t;
    };
  }
  var nr = M (Zn, 2);
  function rr (n, r, t) {
  ...
  function k (n, r, t, e) {
    return E (n) ||
      (n = j (n)), 0 <= ar (n, r, (t = 'number' == typeof t && !e ? t : 0));
  }
  var yr = l (function (n, t, e) {
    var u, o;
    return p (t)
      ? (o = t)
      : ((t = w (t)), (u = t.slice (0, -1)), (t =
          t[t.length - 1])), I (n, function (n) {
      var r = o;
      if (!r) {
  ...
  function mr (n) {
    return n
      ? v (n) ? f.call (n) : X (n) ? n.match (br) : E (n) ? I (n, Tn) : j (n)
      : [];
  }
  function jr (n, r, t) {
  ...
  var Or = l (function (n, r) {
    ...
    Mr = l (function (n, t) {
      ...
      return p (e)
        ...
        : ((t = I (B (t, !1, !1), String)), (e = function (n, r) {
            return !k (t, r);
          })), Or (n, e, r);
    });
  function Er (n, r, t) {
  ...
  function Tr (n, r, t, e) {
    ...
    for (var u = [], o = [], i = 0, a = g (n); i < a; i++) {
      ...
      r && !t
        ? ((i && o === c) || u.push (f), (o = c))
        : t ? k (o, c) || (o.push (c), u.push (f)) : k (u, f) || u.push (f);
    }
    return u;
  }
  var kr = l (function (n) {
  ...
  N (
    ...
    function (r) {
      ...
      m.prototype[r] = function () {
        var n = this._wrapped;
        return null != n &&
          (t.apply (n, arguments), ('shift' !== r && 'splice' !== r) ||
            0 !== n.length ||
            delete n[0]), Fr (this, n);
      };
    }
  ...
  n = Vr ({
    ...
    throttle: function (t, e, u) {
      function o () {
        (l = !1 === u.leading ? 0 : O ()), (i = null), (c = t.apply (
          a,
          f
        )), i || (a = f = null);
      }
      function n () {
        ...
        return (a = this), (f = arguments), r <= 0 || e < r
          ? (i && (clearTimeout (i), (i = null)), (l = n), (c = t.apply (
              a,
              f
            )), i || (a = f = null))
          : i || !1 === u.trailing || (i = setTimeout (o, r)), c;
      }
      var i, a, f, c, l = 0;
